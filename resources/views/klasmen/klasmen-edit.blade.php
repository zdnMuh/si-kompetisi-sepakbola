...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Klasmen</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{url('/klasmen/update/' . $klasmen->id_kompetisi)}}" method="POST">
                @csrf
                @method ('put')
